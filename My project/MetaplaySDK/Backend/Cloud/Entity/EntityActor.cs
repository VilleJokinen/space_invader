...
namespace Metaplay.Cloud.Entity
{
    ...
    /// a <see cref="EntityShard.EntityAskReplyException"/> is returned instead.
    /// </summary>
    ...
    public abstract partial class EntityActor : MetaReceiveActor, IEntityReceiver, IEntityAsker, IEntitySynchronizeCallbacks
    {
        ...
        private void AfterSubscribersLostInternal()
        {
            TryScheduleShutdownAfterSubscriberLoss();
        }

        private void AfterNewSubscribersInternal()
        {
        ...
        protected EntityId GetAssociatedServiceEntityId(EntityKind targetEntityKind)
        {
            ...
            return EntityId.Create(targetEntityKind, _entityId.Value % (uint)shard.RemoteActors.Length);
        }
        ...
        protected virtual Task OnSubscriptionLost(EntitySubscription subscription) { _log.Warning("Unhandled lost subscription to {TargetActor} [{Topic}]", subscription.ActorRef, subscription.Topic); return Task.CompletedTask; }
        ...
        /// </remarks>
        /// <param name="subscription">the kicked subscriber</param>
        /// <param name="message">the message specified in KickSubscriber, if any</param>
